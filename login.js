    ...
    <div ref={vantaRef} className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <div className="bg-white/1.5 backdrop-blur-[6px] rounded-3xl shadow-xl p-8 w-full max-w-md relative z-10 border border-white/10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-200 animate-fade-in-up animation-delay-200">Login to your AgroCare account</p>
        </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white/20 text-gray-200 backdrop-blur-sm rounded">Or continue with</span>
          </div>
        </div>
        ...
        <div className="text-center mt-3 text-sm text-gray-200">
          ...
          <Link href="/register" className="text-green-300 font-medium hover:text-green-400">
            Sign Up
          </Link>
        </div>
        <div className="text-center mt-3 text-sm text-gray-200">
